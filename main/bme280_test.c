...
void init_bme280_sensor(void) {
    ...
    if (ret != ESP_OK) {
        ESP_LOGE("BME280", "Khoi tao BME280 that bai");
        return;
        
    }
    ESP_LOGI("BME280", "Khoi tao BME280 thanh cong");
}

//Đọc dữ liệu nhiệt độ và độ ẩm từ BME280
void bme280_task(void *pvParameters) {
    init_bme280_sensor(); // Khởi tạo cảm biến BME280
    bme280 bme280_device;
