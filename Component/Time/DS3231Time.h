...
#define SECONDS_FROM_1970_TO_2023 1672510200U // Unixtime for 2023-01-01 00:00:00 đã sửa lại
 ...
 * @param[in] format the format of the returned string
 * @return ESP_OK to indicate success
 */
 ...
 * @return true if it is a new day |
 * @return false if it is not a new day
 */
bool ds3231_isNewDay(i2c_dev_t *dev);

/**
 * @brief Test if whether it is new minute or not
 *
 * @param dev Device descriptor
 * @return true if it is a new minute |
 * @return false if it is not a new minute
 */
bool ds3231_isNewMinute(i2c_dev_t *dev);

/**
 * @brief Caculate the number of seconds until new day
 *
 * @param dev Device descriptor
 * @return seconds until a new day (milli seconds) |

 */
unsigned long ds3231_untilNewDay(i2c_dev_t *dev);

/**
 * @brief Caculate the number of seconds until new minute
 *
 * @param dev Device descriptor
 * @return seconds until a new minute (milli seconds) |
